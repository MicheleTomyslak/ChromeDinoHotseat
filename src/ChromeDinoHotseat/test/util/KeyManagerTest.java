...
public class KeyManagerTest {
    ...
    public void testGetDuckKey() {
        ...
        int expResult = KeyEvent.VK_DOWN;
        int result = instance.getDuckKey();
        assertEquals(expResult, result);
        if(expResult==result){
            assertEquals(expResult, result);
        }else{
            fail("Il test case è fallito. Ritornato "+result+" al posto di "+expResult);
        }
    ...
    public void testGetJumpKey() {
        ...
        KeyManager instance = new KeyManager();
        int expResult = KeyEvent.VK_SPACE;
        ...
        if(expResult==result){
            ...
            fail("TestFallito. Ritornato "+result+" al posto di "+expResult);
        }
